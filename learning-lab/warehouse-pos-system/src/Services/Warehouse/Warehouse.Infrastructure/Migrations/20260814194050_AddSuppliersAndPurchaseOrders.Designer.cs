...
namespace Warehouse.Infrastructure.Migrations
{
    ...
    [Migration("20260814194050_AddSuppliersAndPurchaseOrders")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Warehouse.Domain.Entities.OutboxDelivery", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Warehouse.Domain.Entities.OutboxMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Warehouse.Domain.Entities.PurchaseOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Warehouse.Domain.Entities.PurchaseOrderLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Warehouse.Domain.Entities.OutboxDelivery", b =>
                {
                    b.HasOne("Warehouse.Domain.Entities.OutboxMessage", "OutboxMessage")
                        .WithMany()
            ...
            modelBuilder.Entity("Warehouse.Domain.Entities.PurchaseOrderLine", b =>
                {
                    ...
                    b.HasOne("Warehouse.Domain.Entities.PurchaseOrder", "PurchaseOrder")
                        .WithMany("Lines")
